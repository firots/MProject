...
//  Intimer
//
//  Created by Firot on 29.06.2019.
...
extension UIColor {
    func noBlack() -> UIColor {
        if self == UIColor.FlatColor.Black || self == .black {
...
extension UIColor {
    struct FlatColor {
        ...
        struct Red {
            ...
            static let Bright = UIColor(netHex: 0xF93822)
        }
        ...
        static let Black = UIColor(netHex: 0)
...
extension UIColor {
    static let bgColors: [(String,Int)] = [
        ("Black & White", 0x000000),
        ("Chateau Green", 0x4DA664),
        ("Persian Green", 0x2CA786),
        ("Hierophant Green", 0x39FF14),
        
        ("Cinnabar", 0xDC5047),
        ("Well Read", 0xB33234),
        ("Magician's Red", 0xF93822),
    
        ("Picton Blue", 0x5CADCF),
        ("Mariner", 0x3585C5),
        
        ("Wisteria", 0x9069B5),
        ("Blue Gem", 0x533D7F),
        
        ("Neon Carrot", 0x9069B5),
        ("Sun", 0xEE7841),
        
        ("Energy", 0xF2D46F),
        ("Turbo", 0xF7C23E),
        
        ("Almond Frost", 0xA28F85),
        ("Iron Gray", 0x75706B),
